         ...
         <div class="container" data-aos="zoom-in" data-aos-delay="100" >
            ...
            <div class="row mt-3">
              ...
              // dd($newarray);
                      // $lastsavedStep=''; 
                      // end($dataSavedSteps);
                      // $lastkey  = key($dataSavedSteps);

                      // if (!empty($dataSavedSteps)){
                      //      $lastsavedStep= $dataSavedSteps[$lastkey]['parent_step'];
                      // }
               ...
               <div class="col-lg-8 mt-5 mt-lg-0" style="border-radius: 5px;padding-top: 20px;min-height:480px">
                  <div class="form-row" style="background: white;margin-left: unset;margin-right: unset;">
                    <div id="pre-enrollmentBanner" @if (($lastsavedStep =='')|| ($lastsavedStep =='pre1'|| $lastsavedStep =='pre2'|| $lastsavedStep =='pre3'|| $lastsavedStep =='pre4')) class="col-md-3 requestStepActivatedDiasp" @else class="col-md-3 requestStep" @endif > 1. Pré-enrôlement </div>
                    <div id="rdvBanner" @if (!empty($lastsavedStep) &&($lastsavedStep =='pre5' || $lastsavedStep =='rdv1')) class="col-md-3 requestStepActivatedDiasp" @else class="col-md-3 requestStep" @endif> 2. Rendez-vous </div>
                  ...
                  <ul class="steps diasp">
                    ...
                    @php
                        $data_step_one='';$data_step_two='';$data_step_three='';$data_step_four='';$data_step_five='';
                  ...
                  <form id="passport_request_form" action="" autocomplete="off" method="post" role="form" class="php-email-form form-wrapper" style="position:relative;background: white">
                     <input type="hidden" name="rawsitename" id="rawsitename">
                     @csrf
                      {{-- preenrollement --}}
                      ...
                      {{-- preenrollement --}}
                        <fieldset id="step_one" @if (empty($newarray)) class="section is-active"@else class="section" @endif>
                             <h4 style="color: #28285e;background: #28285e14;padding: 5px;">QUI SUIS JE ?</h4>
                              <div class="form-row">
                                 ...
                                 <div class="col-md-6 form-group" style="width:50%">
                                  ...
                                  <div id="qOldpp" class="col-md-12  form-group" style="margin-top: -15px;background: #b0c4de63;display: none">
                                      <p style="margin: 0;font-size: 12px;text-align: center;">Connaissez vous votre ancien code passeport ?&nbsp;&nbsp; <a id="oui_old_pp" style="font-weight: bold;" href="#">OUI</a> &nbsp;&nbsp;&nbsp; <a style="font-weight: bold;color: red" id="non_old_pp" href="#">NON</a> </p>
                                  </div>
                              </div>
                              <div class="form-row">
                                 <div class="col-md-4 form-group input_wrap">
                                    <input type="text" name="numpassport" class="form-control numpassport" id="numpassport" data-rule="minlen:9" data-msg="Entrer un numero passeport" required maxlength="9" disabled  @if (!empty($data_step_one) && array_key_exists("0",$data_step_one)) value="{{$data_step_one[0]}}" @else disabled="disabled" @endif />
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField maxlength25" name="numpiece" id="numpiece" data-rule="minlen:6"  data-msg="Entrer un numero piece valide" required @if (!empty($data_step_one) && array_key_exists("2",$data_step_one)) value="{{$data_step_one[2]}}" @endif />
                              ...
                              <div class="form-row">
                                  ...
                                  <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField " data-inputmask="'alias': 'date'"  name="date_naiss" id="date_naiss"  data-rule="minlen:6" data-msg="Entrer votre date de naissance" required   @if (!empty($data_step_one) && array_key_exists("6",$data_step_one)) value="{{$data_step_one[6]}}" @endif/>
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                    <select  class="form-control requiredField" name="pays_naissance" id="pays_naissance" data-rule="minlen:6" data-msg="Entrer votre pays de naissance">
                                       ...
                                       @foreach ($countries as $country)
                                          <option value="{{$country->abreviation}}" >{{ $country->libelle }}</option>
                                       @endforeach
                                    </select>
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                    <select  class="form-control requiredField" name="pays_residence" id="pays_residence" data-msg="Entrer votre pays de residence">
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control maxlength25" name="profession" id="profession"  data-rule="minlen:6" data-msg="Entrer votre profession" required  @if (!empty($data_step_one) && array_key_exists("11",$data_step_one)) value="{{$data_step_one[11]}}" @else disabled @endif
                                     ...
                                     if (!empty($data_step_one) && array_key_exists("6",$data_step_one)){
                                        $toDate = \Carbon\Carbon::parse($data_step_one[6]);
                              ...
                              <div class="form-row">
                                ...
                                <div class="col-md-12" >
                                   <a id="save_step_one" href="#" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_next">SUIVANT </a>
                                </div>
                                 
                              </div>
                              <!-- <p style="font-size: 12px;font-weight: 600;"> Vous avez déjà un compte ? <span style="color: #28285e">Connectez vous !</span> </p> -->
                        </fieldset>
                        <fieldset id="step_two" @if (!empty($newarray) &&($lastsavedStep =='pre1')) class="section is-active" @else  class="section" @endif >
                              <h4 style="color:#28285e;background: #28285e14;padding: 10px;">FILIATION</h4>
                               ...
                               <div class="form-row">
                                ...
                                <div class="col-md-6 form-group" style="width:50%">
                                 ...
                                 <div class="col-md-6 form-group" style="width:50%">
                                    <label style="display: inline-block;top: -7px;position: relative;font-size:12px">JE NE CONNAIS LA DATE DE NAISSAINCE DES PARENTS</label>
                              ...
                              <div class="form-row">
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                       <input type="text" class="form-control requiredField maxlength25" name="prenom_pere" id="prenom_pere" data-rule="minlen:9" data-msg="Entrer le prénom  du père" required @if (!empty($data_step_two) && array_key_exists("1",$data_step_two)) value="{{$data_step_two[1]}}" @endif/>
                                       <label style="display: block;text-align: left;font-weight:600;" >  Prénoms père    <span style="color: red">*</span></label>
                                       <div class="validate"></div>
                                 </div>

                                  <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField datepicker" name="datenaiss_pere" id="datenaiss_pere"  data-rule="minlen:9" data-msg="Entrer la date de naissance de votre père" required  @if (!empty($data_step_two) && array_key_exists("2",$data_step_two)) value="{{$data_step_two[2]}}" @endif/>
                               ...
                               <div class="form-row">
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                       <input type="text" class="form-control requiredField maxlength25" name="prenoms_mere" id="prenoms_mere" data-rule="minlen:9" data-msg="Entrer le prénom de votre mère" @if (!empty($data_step_two) && array_key_exists("4",$data_step_two)) value="{{$data_step_two[4]}}" @endif required/>
                                       <label style="display: block;text-align: left;font-weight:600;" >  Prénoms mère    <span style="color: red">*</span></label>
                                       <div class="validate"></div>
                                 </div>

                                  <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField datepicker" name="datenaiss_mere" id="datenaiss_mere"  data-rule="minlen:9" data-msg="Entrer la date naissance de votre mère" required  @if (!empty($data_step_two) && array_key_exists("5",$data_step_two)) value="{{$data_step_two[5]}}" @endif/>
                              ...
                              <div class="form-row">
                                  <div class="col-md-12">
                                      <p style="position: relative;background: white;font-size: 14px;font-weight: bold;margin-top: 0px;margin-bottom: 20px;">Personne à contacter en Côte d'ivoire</p>
                                </div>
                              </div>
                               <div class="form-row">
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                       <input type="text" class="form-control requiredField maxlength25" name="person_lastname_contact" id="person_lastname_contact" data-rule="minlen:9" data-msg="Entrer le nom de votre contact " required @if (!empty($data_step_two) && array_key_exists("6",$data_step_two)) value="{{$data_step_two[6]}}" @endif/>
                                       <label style="display: block;text-align: left;font-weight:600;" >  Nom <span style="color: red">*</span></label>
                                       <div class="validate"></div>
                                 </div>
                                 <div class="col-md-4 form-group input_wrap">
                                       <input type="text" class="form-control requiredField maxlength25" name="person_firstname_contact" id="person_firstname_contact" data-rule="minlen:9" data-msg="Entrer le prénom de votre contact" @if (!empty($data_step_two) && array_key_exists("7",$data_step_two)) value="{{$data_step_two[7]}}" @endif required/>
                                       <label style="display: block;text-align: left;font-weight:600;">  Prénoms  <span style="color: red">*</span></label>
                                       <div class="validate"></div>
                                 </div>

                                  <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField datepicker" name="person_contact_birthdate" id="person_contact_birthdate"  data-rule="minlen:9" data-msg="Entrer la date naissance de votre contact" required  @if (!empty($data_step_two) && array_key_exists("8",$data_step_two)) value="{{$data_step_two[8]}}" @endif/>
                                    <label style="display: block;text-align: left;font-weight:600;" >Date de naissance<span style="color: red">*</span></label>
                                    <div class="validate"></div>
                                 </div>
                                  ...
                                  <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField numberonly" name="person_contact_number_phone" id="person_contact_number_phone"  data-rule="minlen:9" data-msg="Entrer le téléphone contact" required  @if (!empty($data_step_two) && array_key_exists("9",$data_step_two)) value="{{$data_step_two[9]}}" @endif/>
                                    <label style="display: block;text-align: left;font-weight:600;" >   Numéro de téléphone   <span style="color: red">*</span></label>
                                    <div class="validate"></div>
                                 </div>
                              </div>
                              ...
                              <div class="form-row ">
                                    <div class="col-md-6" style="width:50%">
                                          <a href="#"  style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_prev" >PRECEDENT</a>
                                    </div>
                                    <div class="col-md-6" style="width:50%">
                                        <a id="save_step_two" href="#" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_next">SUIVANT </a>
                                    </div>
                              </div>
                        </fieldset>
                        <fieldset id="step_three" @if (!empty($newarray) &&($lastsavedStep =='pre2')) class="section is-active" @else  class="section" @endif >
                             <h4 style="color: #28285e;background: #28285e14;padding: 10px;">MA SITUATION ACTUELLE ?</h4>
                              ...
                              <div class="form-row dataconjoint" @if (!empty($data_step_three) && $data_step_three[0]=='C')style="display: none"@endif>
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                       <input type="text" class="form-control requiredField maxlength25" name="prenoms_conjoint" id="prenoms_conjoint"  data-rule="minlen:9" data-msg="Entrer le prenom de votre conjoint"  required @if (!empty($data_step_three) && array_key_exists("2",$data_step_three)) value="{{$data_step_three[2]}}" @else value="" @endif/>
                                       <label style="display: block;text-align: left;font-weight:600;" >  Prénoms conjoint(e)   <span style="color: red">*</span></label>
                                       <div class="validate"></div>
                                 </div>

                                  <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField " name="datenaiss_conj" id="datenaiss_conj"   data-rule="minlen:9" data-msg="Entrer une date naissance de votre conjoint(e)" required @if (!empty($data_step_three) && array_key_exists("3",$data_step_three)) value="{{$data_step_three[3]}}" @else value="" @endif />
                              ...
                              <div class="form-row dataconjoint" @if (!empty($data_step_three) && $data_step_three[0]=='C')style="display: none"@endif>
                                 <div class="col-md-4 form-group input_wrap">
                                       <input type="text" class="form-control requiredField maxlength25" name="lieu_naiss_cj" id="lieu_naiss_cj"  data-rule="minlen:5" data-msg="Entrer le lieu de naissance de votre conjoint(e)" required  @if (!empty($data_step_three) && array_key_exists("4",$data_step_three)) value="{{$data_step_three[4]}}" @else value="" @endif />
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                  ...
                                  <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField maxlength25" name="lieu_mariage" id="lieu_mariage"   data-rule="minlen:9" data-msg="Entrer vptre lieu de mariage" required @if (!empty($data_step_three) && array_key_exists("6",$data_step_three)) value="{{$data_step_three[6]}}" @endif />
                                    <label style="display: block;text-align: left;font-weight:600;" >  Lieu de mariage    <span style="color: red">*</span></label>
                                    <div class="validate"></div>
                                 </div>

                                 <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField maxlength25" name="profession_cj" id="profession_cj"  data-rule="minlen:9" data-msg="Entrer votre profession " @if (!empty($data_step_three) && array_key_exists("7",$data_step_three)) value="{{$data_step_three[7]}}" @endif />
                                    <label style="display: block;text-align: left;font-weight:600;" >  Profession  *    <span style="color: red">*</span></label>
                                    <div class="validate"></div>
                                 </div>
                              </div>
                              ...
                              <div class="form-row ">
                                    ...
                                    <div class="col-md-6" style="width:50%">
                                       {{--  <a id="save_step_three" href="#" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_next">SUIVANT </a> --}}
                        ...
                        <fieldset id="step_four" @if (!empty($newarray) &&($lastsavedStep =='pre3')) class="section is-active" @else  class="section" @endif >
                            ...
                            <div class="form-row ">
                                ...
                                <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField maxlength25" name="region" id="region"  data-rule="minlen:9" data-msg="Entrer votre region " @if (!empty($data_step_four) && array_key_exists("0",$data_step_four)) value="{{$data_step_four[0]}}" @endif />
                                  ...
                                  <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField maxlength25" name="departement" id="departement"  data-rule="minlen:9" data-msg="Entrer votre departement" @if (!empty($data_step_four) && array_key_exists("1",$data_step_four)) value="{{$data_step_four[1]}}" @endif />
                                    <label style="display: block;text-align: left;font-weight:600;" >  Département  <span style="color: red">*</span></label>
                                    <div class="validate"></div>
                                 </div>


                                 <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control requiredField maxlength25" name="ville" id="ville"  data-rule="minlen:9" data-msg="Entrer votre ville / commune" @if (!empty($data_step_four) && array_key_exists("2",$data_step_four)) value="{{$data_step_four[2]}}" @endif />
                           ...
                           {{--  <div id="spinner0" class="col-md-12 form-group input_wrap" style="margin-bottom: 0px;margin-top: -20px;display: none;">
                             ...
                             <div class="form-row "> 
                                 ...
                                 <div class="col-md-4 form-group input_wrap">
                                    <input type="text" class="form-control maxlength25 requiredField" name="boite_postale" id="boite_postale"  data-rule="minlen:9" data-msg="Entrer votre boite postale" required @if (!empty($data_step_four) && array_key_exists("4",$data_step_four)) value="{{$data_step_four[4]}}"  @endif/>
                               ...
                               <div class="form-row ">
                                    ...
                                    <div class="col-md-6" style="width:50%">
                                       {{--  <a id="save_step_four" href="#" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_next">SUIVANT </a>
 --}}
                        ...
                        <fieldset id="step_five" @if (!empty($newarray) &&($lastsavedStep =='pre4')) class="section is-active" @else  class="section" @endif >
                            ...
                            <div class="form-row ">
                                    ...
                                    <div class="col-md-6" style="width:50%">
                                        {{-- <a href="#" id="save_step_five" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_next">VALIDER </a> --}}
                         ...
                         <fieldset id="step_recap"   class="section">
                            ...
                            <div class="form-row " style="margin-top: 30px">
                             ...
                             <div class="form-row ">
                                    <div class="col-md-6" style="width:50%">
                                          <a id="edit_data" href="#" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block"  >MODIFIER</a>
                                    </div>
                                    <div class="col-md-6" style="width:50%">
                         ...
                         {{-- rendez-vous --}}
                         <fieldset id="step_six" @if (!empty($lastsavedStep) &&($lastsavedStep =='pre5')) class="section is-active" @else  class="section" @endif>

                            <h4 style="color: #28285e;background: #28285e14;padding: 10px;">DONNEES PERSONNELLES   </h4>
                            <span style="color: #29285e;font-weight: bold;font-size: 13px;">Entrer un numéro de téléphone valide *</span>
                            <div class="form-row " style="margin-top: 30px">
                                 ...
                                 <div class="col-md-6 form-group input_wrap">
                                   {{-- <span class="input-group-addon"><strong>225</strong></span> --}}
                                    ...
                                    <input style="width: 30%;float: left;margin-right: 30px" type="text" name="indicatif" class="form-control requiredField indicatif " id="indicatif" placeholder="" data-rule="minlen:4" data-msg="Entrer votre indicatif" required @if (!empty($data_step_six) && array_key_exists("2",$data_step_six)) value="{{$data_step_six[2]}}" @endif/>
                                    <label style="text-align: left;">indicatif <span style="color: red">*</span></label>




                                       <input style="width: 60%;float: left;" type="text" class="form-control requiredField numberonly" name="telephonerdv" id="telephonerdv" data-rule="minlen:9" data-msg="Entrer votre numéro de téléphone" required @if (!empty($data_step_six) && array_key_exists("1",$data_step_six)) value="{{$data_step_six[1]}}" @endif/>
                            ...
                            <div class="form-row ">
                                    <div class="col-md-6" style="width:50%">
                                          <a id="back_pre_enrol" href="#" class="button_prev"  style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" >PRECEDENT</a>
                                    </div>
                                    <div class="col-md-6" style="width:50%">
                                       {{--  <a href="#" id="save_step_six" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_next">SUIVANT </a> --}}
                        ...
                        <fieldset id="step_seven" @if (!empty($lastsavedStep) &&($lastsavedStep =='rdv1')) class="section is-active" @else  class="section" @endif>
                            ...
                            <div class="form-row">
                                 ...
                                 <div class="col-md-6 form-group input_wrap">
                                    <select id="formulerdv_diapo"  class="form-control requiredField" name="formulerdv" data-rule="minlen:6" data-msg="selectionner le type de pièce">
                            ...
                            <div class="form-row ">
                                    <div class="col-md-12">
                                          <a id="back_to_stepO_rdv" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_prev" href="#" >PRECEDENT</a>
                                    </div>
                                   {{--  <div class="col-md-6" style="width:50%">
                                        <a id="save_step_five" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_next">VALIDER </a>
                                    </div> --}}
                              </div>
                        </fieldset>
                        ...
                        {{-- confirmation --}}
                         <fieldset id="step_eight" class="section ">
                                     ...
                                     <tr style="background: #babacb;color: black">
                                       ...
                                       <th>MONTANT</th>
                                        ...
                                        <tr style="border:dashed 2px #575288">
                                          ...
                                          <td style="font-weight: bold;">{{$montant_recu_p}} </td>
                                        </tr>
                                        <tr style="border:dashed 2px #575288">
                                          <td style="font-weight: bold;">Frais de transaction(digitale)  </td>
                                          <td style="font-weight: bold;">{{$frais_transac_dig}} </td>
                                        </tr>


                                        <tr style="border:dashed 2px #575288">
                                          <td style="font-weight: bold;">Frais Service(prise de Rendez-vous) </td>
                                          <td id="fraisrdv" style="font-weight: bold;"><span id="mntrdv">{{$frais_serv_rdv}} </span></td>
                                        </tr>
                                          <tr style="border: dashed 2px #575288;background: #28285e;color: white;">
                                          <td style="font-weight: bold;">TOTAL </td>
                                          <td id="totalpayment" style="font-weight: bold;">{{$montant_recu_p + $frais_serv_rdv + $frais_transac_dig}} €</td>
                                        </tr>
                                    </table>

                                   <div class="col-md-12" style="margin-bottom: 40px">
                                      <p style="font-size: 10px">
                                        Vous vous apprêtez à finaliser votre demande passeport biométrique, vous serez débité de <span style="color: #28285e;font-weight: bold;" id="paymentmsg"> {{$montant_recu_p + $frais_serv_rdv + $frais_transac_dig}} €</span> relatif aux frais de paiement passeport biométrique et de la prise Rendez-vous.
                                      </p>
                                   </div>
                            ...
                            <div class="form-row ">
                                    ...
                                    <div class="col-md-6" style="width:50%">
                                      {{--   <a href="#" id="save_step_eight" style="background: #28285e;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block">VALIDER </a> --}}


                                       <a id="save_step_eight" href="#" style="background: #28285e" class="customBtn  progress-button" data-progress-button>
                                                    <span class="progress-button-indicator"></span>
                                                    <span class="progress-button-content">
                                                        <span class="progress-button-before">VALIDER</span>
                                                        <span class="progress-button-after">PATIENTER</span>
                        ...
                        <a id="popca" class="js-openCa btn-open is-active" style="z-index: 100;height: 30px;;background: #cacbdf; display: none;">Show modal</a>
                         <div class="wrap popop">
                          <div class="modal js-modal initialpop" style="position: relative;width: 95%;top:20px;margin: 0 auto;background: #cacbdf">
   ...
   <script type="text/javascript">
    // global variable 
       ...
       var type_resident ='2';
       var passport_type ='passport_foreign';
       var rdv_payant =0;
        // $("#finalrequestbtn").trigger('click');

   </script>
   {{-- <script type="text/javascript" src="/modals/modals_customizedCalendar.js"></script> --}}
   ...
   <script type="text/javascript" src="/assets/js/calendar_diaspo.js"></script>
   ...
   <script type="text/javascript" src="{{mix('/assets/js/demandesDiasp.js')}} "></script>
   <script type="text/javascript" src="{{mix('/assets/js/form_validation_diasp.js')}}"></script>
   ...
   <script type="text/javascript">
    ...
    // showModalChildren();
         ...
         $("#person_contact_birthdate").inputmask({ alias: "date", placeholder:"jj/mm/aaaa",});
