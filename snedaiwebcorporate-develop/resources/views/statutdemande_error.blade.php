                  ...
                  <form id="formstatusdmd" autocomplete="off" action="" method="post" role="form" class="php-email-form form-wrapper" style="position:relative">
                        <fieldset class="section is-active" style="min-height: 380px;">
                          <div id="form_edit_user_info">
                             ...
                             <p style="font-size: 20px; margin:20px;color: #f46e23;">Information </p>
                          ...
                          <div id="flash" class="flash" style="margin-bottom: 10px;">
                            <div role="alert" ng-show="hasFlash" class="alert  alert-dismissible alertIn alertOut ng-animate alert-danger"> 
                              ...
                              <div class="form-row" >
                                <img src="/assets/img/alerte.png" style="display: block; height: 100px;width: 100px;margin: 5px auto 10px;">

                                <h2 style="font-size: 27px;text-align: center;display: block;margin: 0 auto;color: #27285e;">Service momentanément indisponible veuillez reéssayer plutard .</h2>

                              </div>
                              <div class="form-row">
                                <div class="col-md-12" style="margin-top:30px;">
                                   <a  href="/" style="background: #f36e23" class="customBtn  progress-button" data-progress-button>
