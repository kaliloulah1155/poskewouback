  ...
  @section('content')
	<section id="hero" class="d-flex flex-column justify-content-center inscription">
	    <div class="container" data-aos="zoom-in" data-aos-delay="100" >
	      <h1 style="color: white">Modification Rendez-Vous</h1>
	             ...
	             @csrf
	              ...
	              <div class="form-row">
	                  <div class="col-md-12 form-group input_wrap">
	                  	 <p style="text-align: center;display: block;margin: 7px auto;color: #28285e;">Je modifie mon rendez-vous :</p>
	              ...
	              <div class="form-row">
	                  <div class="col-md-6 form-group input_wrap" style="text-align: center;">
	                   <a class="btn" style="background: #f46e23;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 5px;width: 315px" href="/modifier_rdv" > En Côte d'Ivoire</a>
	                   
	                  </div>

	                  <div class="col-md-6 form-group input_wrap" style="text-align: center;">
	                    <a class="btn" style="background: #28285e;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 5px;width: 315px;" href="/modifier_rdv_diaspora">Dans une ambassade</a>
