 ...
 <!-- ======= Hero Section ======= -->
            ...
            <div class="row mt-3">
               <div class="col-lg-8 mt-5 mt-lg-0" style="border-radius: 5px;padding-top: 20px;min-height:500px">
                  <div class="form-row" style="background: white;margin-left: unset;margin-right: unset;">
                    ...
                    <div id="rdvBanner" class="col-md-4 requestStepActivated"> 1. Rendez-vous </div>
                    <div id="confirmationBanner" class="col-md-4 requestStep"> 2. Confirmation </div>
                    <div id="paiementBanner" class="col-md-4 requestStep"> 3. Informations </div>
                  </div>
                  <ul class="steps">
                   
                    <li  class="rdv is-active">Etape 1</li>
                    <li  class="rdv">Etape 2</li>
                    <li style="display: none" class="confirmation">Votre opération</li>
                  </ul>
                      ...
                      @csrf
                         ...
                         <fieldset id="step_six" class="section is-active">
                            ...
                            <div class="form-row form-rdvcode" style="margin-top: 50px;margin-bottom: 50px">
                                <div class="col-md-12" style="margin-bottom:10px">
                                    <span style="font-weight:bold;">Pour votre passeport en côte d’Ivoire, Vous avez la possibilité de modifier votre rendez-vous en ligne 48 heures avant sa date initiale</span>
                                </div>
                            ...
                            <div class="form-row ">
                                    <div class="col-md-6" style="width:50%">
                                          <a href="/"  style="background: #f36e23;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" >ACCUEIL</a>
                                    </div>
                                    <div class="col-md-6" style="width:50%">
                                       {{--  <a href="#" id="check_rdv_code" style="background: #f36e23;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block" class="button_next">VERIFIER LE CODE </a>
                                        <br> --}}
                                        <a id="check_rdv_code" href="#" style="background: #f36e23" class="customBtn button_next progress-button" data-progress-button data-button-svg="Animated SVG">
                          ...
                          <div id="oldrdvinfo">
                            ...
                            <div class="form-row">
                                 <div class="col-md-12 form-group input_wrap" style="background: #e7e7e79c; padding: 5px;margin-bottom: 5px">
                                  <p style="font-size: 13px;text-align: left;margin-top: 0px;"> <span style="color: #f36e23;margin-right: 30px;font-weight: 500">Site: </span> <span id="lieurdv" style="color: black;font-weight: 500;">...</span> </p>
                                 </div>

                                 <div class="col-md-12 form-group input_wrap" style="background: #e7e7e79c; padding: 5px;">
                                  <p style="font-size: 13px;text-align: left;margin-top: 0px;">  <span style="color: #f36e23;margin-right: 30px;font-weight: 500"> Date et Heure: </span> <span id="dateHrdv" style="color: black;font-weight: 500;">...</span> </p>
                                 </div>
                        ...
                        <fieldset id="step_nine" class="section">
                            ...
                            <div class="form-row " style="margin-top:20px">
                                    ...
                                    <div class="col-md-6" style="width:50%">
                                        {{-- <a href="#" id="confirmEditRdv" style="background: #f36e23;border: 0;padding: 10px 5px;color: #fff;transition: 0.4s;border-radius: 5px;display:block">VALIDER</a> --}}
                        ...
                        <fieldset id="step_ten" class="section" style="background:white">
                              ...
                              <div class="form-row">
                                      <div class="col-md-12 form-group input_wrap" id="sucessmsg">
                                         <p style="text-align: center;display: block;margin: 7px auto;color: green;">Operation réussie !</p>
                                      ...
                                      <div class="col-md-12 form-group input_wrap" id="errormsg" style="display:none">
                                         <p style="text-align: center;display: block;margin: 7px auto;color: red;">Operation echouée !</p>
   ...
   {{-- <script type="text/javascript" src="/assets/js/modif_rdv.js"></script> --}}
   <script type="text/javascript" src="{{mix('/assets/js/modif_rdv.js')}} "></script>
   <script type="text/javascript" src="/assets/js/calendar_edit_rdv.js"></script>
