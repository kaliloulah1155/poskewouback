  ...
  @section('content')
	<section id="hero" class="d-flex flex-column justify-content-center inscription">
	    <div class="container" data-aos="zoom-in" data-aos-delay="100" >
	      <h1 style="color: white">Demande  diaspora </h1>
	            ...
	            <form action="" method="post" role="form" class="php-email-form" style="padding: 10px">
	              ...
	              <div class="form-row">
	                  <div class="col-md-12 form-group input_wrap">
	                  	 ...
	                  	 {{--   <p style="font-size: 14px;text-align: center;">Merci de choisir le cas selon votre le type d'opération.</p> --}}
	              ...
	              <div class="form-row">
	                  <div class="col-md-6 form-group input_wrap" style="text-align: center;">
	                   <a class="btn" style="background: #f36e23;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 5px;" href="/demandes_diaspora" >Faire une demande de passeport</a>
	                   
	                  </div>

	                  <div class="col-md-6 form-group input_wrap" style="text-align: center;">
	                    
	                    <a class="btn" style="background: #28285e;border: 0;padding: 10px 35px;color: #fff;transition: 0.4s;border-radius: 5px;width: 315px;" href="/modifier_rdv_diaspora">Modifier un rendez-vous </a>
