                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Historique des achats</h4>
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                	...
                                	<div class="flex-grow-1">
                                		 <h4 class="card-title " style="display: inline-block; margin-right: 10px;">Historiques</h4>

                                		  <div class="form-icon right" style="display: inline-block;margin-right: 10px;">
	                                            <input type="email" class="form-control form-control-icon" id="iconrightInput" placeholder="N° Passeport">
	                                            
	                                       </div>


	                                        <div class="form-icon right" style="display: inline-block;margin-right: 10px;">
	                                            <input type="email" class="form-control form-control-icon" id="iconrightInput" placeholder="Nom">
	                                        ...
	                                        <div class="form-icon right" style="display: inline-block;margin-right: 10px;">
	                                            <input type="email" class="form-control form-control-icon" id="iconrightInput" placeholder="Date debut">
	                                        ...
	                                        <div class="form-icon right" style="display: inline-block;margin-right: 10px;">
	                                            <input type="email" class="form-control form-control-icon" id="iconrightInput" placeholder="Date fin">
	                                            <i class="ri-mail-unread-line"></i>
	                                       </div>
                                    ...
                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="form-check form-switch form-switch-right form-switch-md">
                                           <a href="/inscription_corporate" target="_blank" class="btn btn-primary w-100">Rechercher</a>
