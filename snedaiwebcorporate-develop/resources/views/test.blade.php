<div class="pt-triggers">
   ...
   <a id="launchanimation" data-animation="4" href="#">Move to bottom/ from top,hkjhjh</a>
      ...
      <ul class="dl-menu">
         <li>
            ...
            <ul class="dl-submenu">
               ...
               <li data-animation="4"><a href="#">Move to bottom/ from top,hkjhjh</a></li>
            </ul>
         </li>
         <li>
            <a href="#">Fade</a>
...
<footer>
   <p>
      <strong>Re-Made 
      <a href="https://twitter.com/roswellparian" target="_blank">@roswellparian</a> by Parian
      </strong>
   </p>
</footer>
